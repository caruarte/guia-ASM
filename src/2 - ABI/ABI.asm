...
; registros y pila: x1[edi], x2[esi], x3[edx], x4[ecx], x5[r8d], x6[r9d], x7[stack], x8[stack]]
alternate_sum_8:
	;prologo
  push RBP
  mov rbp, rsp
  ...
  add EDI, r8d
  sub edi, r9d
  add edi, [rbp + 16] ; en +8 esta la direccion de retorno
  sub edi, [rbp + 24] ; no hace falta poner dword porque lo asume del registro de destino
  mov eax, edi
...
product_2_f:
  ...
  cvtsi2sd xmm1, esi ; paso todo a double
  cvtss2sd xmm0, xmm0
  mulsd xmm0, xmm1
  cvttsd2si eax, xmm0
  mov DWORD [rdi], eax
