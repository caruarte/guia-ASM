...
cantidad_total_de_elementos:
	push rbp
	mov rbp, rsp
	mov r8, [rdi + LISTA_OFFSET_HEAD]
	xor eax, eax
	.ciclo:
		add eax, [r8 + NODO_OFFSET_LONGITUD]
		mov r8, [r8 + NODO_OFFSET_NEXT]
		cmp R8, 0
		jne .ciclo
	pop rbp
	ret
...
cantidad_total_de_elementos_packed:
	push rbp
	mov rbp, rsp
	mov r10, [rdi + PACKED_LISTA_OFFSET_HEAD]
	xor eax, eax
	.ciclo2:
		add eax, [r10 + PACKED_NODO_OFFSET_LONGITUD]
		mov r10, [r10 + PACKED_NODO_OFFSET_NEXT]
		CMP r10, 0
		jne .ciclo2
	pop rbp
	ret
